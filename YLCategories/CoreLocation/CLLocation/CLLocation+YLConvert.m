...
@implementation CLLocation (YLConvert)
...
+ (CLLocationCoordinate2D)yl_bd09ToWgs84:(CLLocationCoordinate2D)location {
    CLLocationCoordinate2D gcj02 = [self yl_bd09ToGcj02:location];
    return [self gcj02Decrypt:gcj02.latitude gjLon:gcj02.longitude];
}

- (instancetype)yl_locationFromWgs84ToGcj02 {
    CLLocationCoordinate2D trans_loc = [self.class yl_wgs84ToGcj02:self.coordinate];
